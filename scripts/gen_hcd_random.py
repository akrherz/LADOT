...
"""
 1 Jan 1970 - 31 Dec 1974
 1 Jan 1975 - 31 Dec 1978
 1 Jan 1979 - 31 Dec 1982
 1 Jan 1983 - 31 Dec 1987
 1 Jan 1988 - 31 Dec 1991
 1 Jan 1992 - 31 Dec 1996
 1 Jan 1997 - 31 Dec 2002
 1 Jan 2003 - 31 Dec 2009
"""
import os
import math
import numpy
...
def runner():
  for line in open('/mesonet/share/pickup/ladot/station.dat'):
    tokens = line.split(",")
    stid = tokens[0]
    #if stid != '00070':
    #  continue
